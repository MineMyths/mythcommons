...
fun String.asMini(tagResolver: TagResolver = TagResolver.empty()): Component =
...
fun Component.undecorate(decoration: TextDecoration): Component =
    this.decoration(decoration, TextDecoration.State.FALSE)
...
fun Component.undecorate(vararg decorations: TextDecoration): Component =
    this.decorations(decorations.associateWith { TextDecoration.State.FALSE })
...
fun Any.asComponent() = MiniMessage.miniMessage().deserialize(this.toString()).undecorate(TextDecoration.ITALIC)
fun Any.asLegacyComponent() =
    LegacyComponentSerializer.legacyAmpersand().deserialize(this.toString()).undecorate(TextDecoration.ITALIC)
